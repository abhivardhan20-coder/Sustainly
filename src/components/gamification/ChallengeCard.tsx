...
export default function ChallengeCard({ challenge, onProgress }: ChallengeCardProps) {
  ...
  return (
    <div className={`relative bg-surface-container-lowest rounded-2xl p-5 border overflow-hidden transition-all duration-300 ${isCompleted ? 'border-primary shadow-sm' : 'border-surface-variant/50'}`}>
      {isCompleted && (
